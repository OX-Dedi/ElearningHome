		...
		<div class="col-md-6">
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        ...
                        <p>Klik tombol <b>Backup Database</b> untuk melakukan Backup database E-Learning CBT. Simpan backup database pada tempat yang aman.</p>
					...
					<div class="box-footer">
                        <button type="submit" class="btn btn-success" id="backup-database">Backup Database</button>
                    </div>
                </div>
        </div>
        <div class="col-md-6">
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        ...
                        <p>Klik tombol <b>Backup Data Upload</b> untuk melakukan Backup Data yang di Upload (gambar, audio) pada E-Learning CBT. Simpan backup data pada tempat yang aman.</p>
                        <p>Data file yang di upload akan disimpan dalam bentuk archive.</p>
                        <p>Restore Data Upload dilakukan dengan meng-copy data ke folder uploads pada folder utama E-Learning</p>
                    </div>
					
					<div class="box-footer">
                        <button type="submit" class="btn btn-success" id="backup-data-upload">Backup Data Upload</button>
                    </div>
                </div>
        </div>
    </div>
		...
		<div class="col-md-6">
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        ...
                        <p>Setelah E-Learning digunakan dalam waktu yang lama dan menjalan banyak TES, maka session harus dibersikan.</p>
					...
					<div class="box-footer">
                        <button type="submit" class="btn btn-success" id="backup-session">Clear Sessions</button>
                    </div>
                </div>
        </div>
	</div>
