	...
	<div class="row">
        <div class="col-md-12">
            <div class="callout callout-danger">
                <h4>Informasi</h4>
                <p>Lakukan Pengaturan nama pelaksana E-Learning sebelum mencetak kartu peserta agar kartu sesuai dengan Organisasi tempat anda melaksanakan Tes.</p>
			...
			<?php echo form_open($url.'/kartu','id="form-kartu"'); ?>
                <div class="box box-danger">
					...
					<div class="box-footer">
                        <button type="button" class="btn btn-success" id="kartu">Cetak kartu</button>
                    </div>
                </div>
			<?php echo form_close(); ?> 
        </div>
