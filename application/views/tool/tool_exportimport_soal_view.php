...
<section class="content-header">
	<h1>
		...
		<small>Fasilitas untuk melakukan Export dan Import data Soal yang sudah dimasukkan ke E-Learning CBT</small>
	</h1>
	<ol class="breadcrumb">
	...
	<div class="row">
        <div class="col-xs-12">
            <div class="callout callout-danger">
                <h4>Informasi</h4>
                <p>Export / Import dapat digunakan untuk mendistribusikan Soal yang sudah di entry. Soal didistribusikan ke server lain yang sudah terinstall E-Learning CBT.</p>
                <p>Pastikan sebelum melakukan Import Data Soal tidak ada Topik pada E-Learning.</p>
            </div>
        </div>
    </div>
    <div class="row">
		...
		<div class="col-md-6">
                <div class="box box-danger">
					...
					<div class="box-footer">
                        <button type="button" class="btn btn-success" id="export-soal">Export Data Soal</button>
                    </div>
                </div>
        </div>
        <div class="col-md-6">
            <?php echo form_open_multipart($url.'/importsoal','id="form-import"'); ?>
                <div class="box box-danger">
					...
					<div class="box-footer">
                        <button type="submit" class="btn btn-success" id="import-soal">Import Data Soal</button>
                    </div>
                </div>
            </form>
        </div>
