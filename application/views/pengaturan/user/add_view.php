    ...
    <div class="col-xs-12">
        <div class="box box-danger">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group input-group-sm">
                                    ...
                                    <span class="input-group-btn">
                                        ...
                                        <button class="btn btn-danger btn-flat" type="button" id="btn-topik-hapus">Hapus</button>
                                    </span>
                                </div>
            ...
            <div class="box-footer">
                <button type="submit" id="btn-simpan" class="btn btn-success pull-right">Simpan</button>
            </div>
        </div>
    </div>
    </div>
